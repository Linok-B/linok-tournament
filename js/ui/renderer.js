                ...
                matchBox.innerHTML = `
                    <div style="display:flex; height:100%; align-items:center;">
                        ...
                        <div style="display:flex; flex-direction:column; gap:8px;">
                            <input type="number" id="s1-${match.id}" style="width:45px; height:20px; background:var(--bg-dark); color:white; border:1px solid #45475a;" value="${match.score1}">
                            <input type="number" id="s2-${match.id}" style="width:45px; height:20px; background:var(--bg-dark); color:white; border:1px solid #45475a;" value="${match.score2}">
                        </div>
