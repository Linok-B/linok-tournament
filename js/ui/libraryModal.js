...
export async function openTournamentLibraryModal(currentTournament, onSwitchTournament) {
    ...
    function render() {
        ...
        modal.innerHTML = `
            ...
            <!-- Selection Bar -->
            <div id="library-select-bar" style="display:flex; justify-content:space-between; align-items:center; background:var(--bg-dark); min-height:42px; padding:6px 10px; border-radius:4px; margin-bottom:10px; border:1px solid var(--border-main); box-sizing:border-box;">
